...
import com.samsbeauty.warehouse.security.exception.AuthMethodNotSupportedException;
import com.samsbeauty.warehouse.security.model.LoginRequest;
...
public class RestLoginProcessingFilter extends AbstractAuthenticationProcessingFilter {
	...
	@Override
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException, JsonMappingException {
		...
		try {
			...
			throw new AuthMethodNotSupportedException("Content is empty");
		}
	}
